...
%\todo{you should use equasion package for equasions. see https://en.wikibooks.org/wiki/LaTeX/Mathematics. THAT I KNOW BUT FIRST, I WANT IT TO BE PART OF THE TEXT AND NOT A SEPARATED FORMULA SINCE IT S NOT THAT IMPORTANT, AND SECOND, THERE IS NO DIFFERENCE LOOKWISE EXCEPT FOR THE LABEL NUMBER }
...
\label{imparch}
%\todo{this part appears out of nowhere: no transition(IS IT BETTER NOW?!). also it mentions caffe, which was introduced a while ago. HAVING CAFFE INTRODUCED= BY/WITH/AFTER INTRODUCING CAFFE }
