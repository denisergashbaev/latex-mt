...
\indent In order to not lose information, we used merely two pooling layers for the first two convolutional layers. Each pooling layer has a kernel size of $2\times2$ with stride = 1 \todo{what is `stride' -- i don't think that you've ever explained it} and padding = 0. 
