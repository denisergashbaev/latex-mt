...
\todo{tables are ugly, can't you please style them up (whith finer borders)}
\begin{table}[H]
	\centering
...
As fully discussed in chapter~\ref{subsec:synped}, for the particular case study, we synthetically created a dataset of 1 million images. To recap, the dataset specifications are the following\todo{no need to repeat the information, but i like the description of the dataset here better}:
\begin{itemize}
